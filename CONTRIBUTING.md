# Contributing to download-install-action

First and foremost, thank you! We appreciate that you want to contribute to download-install-action, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for download-install-action**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for download-install-action:

- star the [project](https://github.com/joncloud/download-install-action)
- tweet your support for download-install-action
...
- **version**: (required) please note the version of download-install-action are you using
...
The original poster or the maintainers of download-install-action may close an issue at any time. Typically, but not exclusively, issues are closed when:
...
[so]: http://stackoverflow.com/questions/tagged/download-install-action
